function gameplay(e){
	...
	*/
	...
	function showClue(){
		...
		var $800supremeCourtClue='THIS LANDMARK RULING DECLARED THE SEPARATE BUT EQUAL CONCEPT TO BE UNCONSTITUTIONAL AS IT VIOLATED THE 14TH AMENDMENT';
	...
	function answerAndScore(){
		...
		function markAnswer(){
			...
			*/
			...
			if ($totalPrize<0){
				$('#answer').find('span').eq(2).addClass('negative'); 
			} else {
				$('#answer').find('span').eq(2).addClass('positive'); 				
			}
