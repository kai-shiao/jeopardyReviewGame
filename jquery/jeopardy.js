function gameplay(e){
	...
	*/
	...
	function showClue(){
		...
		var $600colonialAmericaClue=' ';
			$600colonialAmericaClue+='OF COMMUNISM ABROAD. IT OFTEN MANIFESTED ITSELF IN THE FORM OF INSTALLING PRO-AMERICAN ANTI-COMMUNIST ';		
	...
	function answerAndScore(){
		...
		function markAnswer(){
			...
			var $answers=['','','','','', 
						  ...
						  'REGIONALISM','OLIVE BRANCH PETITION','ORIGINAL JURISDICTION','TRIANGULAR TRADE','KEYNES',
